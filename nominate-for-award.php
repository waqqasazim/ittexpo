...
<head>
   ...
   <title>Nominate For Award</title>
</head>
      ...
      <div class="d-table-cell align-middle">
         <div class="container">
            <div class="banner-inner-con text-white text-center wow bounceInUp" data-wow-duration="2s">
               <h1 class="position-relative">Nominate For Award</h1>
               <nav aria-label="breadcrumb breadcrumb-col ">
                  <ol class="breadcrumb d-inline-block">
                     ...
                     <li class="breadcrumb-item active text-white d-inline-block" aria-current="page">Nominate For Award</li>
                  </ol>
               </nav>
            </div>
         </div>
