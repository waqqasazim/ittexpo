      ...
      <div class="d-table-cell align-middle">
         <div class="container">
            <div class="banner-inner-con text-white text-center wow bounceInUp" data-wow-duration="2s">
               <h1 class="position-relative">Brochure</h1>
               <nav aria-label="breadcrumb breadcrumb-col ">
                  <ol class="breadcrumb d-inline-block">
                     ...
                     <li class="breadcrumb-item active text-white d-inline-block" aria-current="page">Brochure</li>
                  </ol>
               </nav>
            </div>
         </div>
   ...
   <section class="about-us-main-sec w-100 float-left d-flex padding-top padding-bottom">
      <div class="about-text-con wow bounceInUp" data-wow-duration="2s">
         ...
         <ul style="margin-left: 20px;">
            <li><a href="">ITT EXPO SPONSORSHIP - 2024 - 25</a></li>

            <li><a href="">IIT EXPO BROCHURE 2024-25</a></li>

            <li><a href="">INTERNATIONAL TRAVEL & TRADE CONFERENCE 2024</a></li>
